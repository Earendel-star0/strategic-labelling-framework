...
The name of the idea, artefact, or concept being labelled. Multi-word names use underscore convention.
...
The thing the Subject relates to. Follows the same naming convention as Subject — underscore for multi-word names.
...
!⊕∃F: EGAP_v2.0.1 ⊢ Garden's_Tensor_Logic
...
~∃F: My Concept               ← spaces in subject name
