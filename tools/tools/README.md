...
bashpython3 validate_label.py "~∃F: My_Concept"
Usage
Command line
Validate a single label:
bashpython3 validate_label.py "~∃F: Strategic_Labelling_Framework"
Output JSON:
bashpython3 validate_label.py "~∃F: Concept ⊢ Other_Concept" --json
In Python
pythonfrom validate_label import validate_label
...
python# Pseudo-code for an AI system
